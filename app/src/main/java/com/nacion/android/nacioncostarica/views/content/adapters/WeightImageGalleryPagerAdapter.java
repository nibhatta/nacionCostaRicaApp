...
public class WeightImageGalleryPagerAdapter extends FragmentStatePagerAdapter {
    private List<ContentFragment> fragments;
    private int tabsCount;

    public WeightImageGalleryPagerAdapter(FragmentManager argManager, List<ContentFragment> argFragments){
        super(argManager);
